...
describe('GET /api/posts', () => {
  ...
  beforeEach(() => {
    ...
    (mockedPrisma.post.findMany as jest.Mock).mockResolvedValue([]); // Явно приводимо до Jest.Mock
  });
  ...
  it('повертає 200 і масив постів, якщо вони існують', async () => {
    ...
    (mockedPrisma.post.findMany as jest.Mock).mockResolvedValue(mockPosts); // Явно приводимо до Jest.Mock
