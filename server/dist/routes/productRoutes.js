...
import { createProduct, deleteProduct, getCreatorProducts, getMuseumProducts, getProductByAuthorId, getProductByExhibitionId, getProductById, getProductByMuseumId, getProducts, getUserProducts, updateProduct, } from "../controllers/productController.js";
...
router.post("/", authenticateToken, authorize("MUSEUM", "CREATOR", "ADMIN"), uploadPaintings.array("productImages", 7), 
// Maximum of 7 images
[
...
router.put("/:id", authenticateToken, uploadPaintings.array("productImages", 7), [
    body("title_en").notEmpty().withMessage("Title is required"),
    body("description_en").notEmpty().withMessage("Description is required"),
    body("title_uk").notEmpty().withMessage("Потрібен заголовок"),
    body("description_uk").notEmpty().withMessage("Потрібен опис"),
