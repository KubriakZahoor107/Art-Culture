...
import { createProduct, getProducts, getProductById, getUserProducts, getCreatorProducts, getProductByAuthorId, getMuseumProducts, getProductByMuseumId, getProductByExhibitionId, updateProduct,
...
router.post("/", authenticateToken, authorize("MUSEUM", "CREATOR", "ADMIN"), uploadPaintings.array("productImages", 7), createProduct);
// READ
...
// UPDATE
router.put("/:id", authenticateToken, authorize("MUSEUM", "CREATOR", "ADMIN"), uploadPaintings.array("productImages", 7), updateProduct);
