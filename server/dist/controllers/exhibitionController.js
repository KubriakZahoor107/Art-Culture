...
export const createExhibitions = async (req, res, next) => {
    try {
        ...
        const { title_en, title_uk, description_en, description_uk, startDate, endDate, time, endTime, location_en, location_uk, latitude, longitude, address, museumId, } = req.body;
...
export const updateExhibition = async (req, res, next) => {
    try {
        const { id } = req.params;
        const { title_en, title_uk, description_en, description_uk, startDate, endDate, time, endTime, location_en, location_uk, latitude, longitude, address, } = req.body;
